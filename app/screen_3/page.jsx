          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="bg-white px-6 py-4 flex items-center justify-between border-t border-gray-200">
              <div className="flex w-36 md:w-40">
                <select
                  className="block w-full appearance-none border border-gray-300 bg-gray-50 text-gray-900 focus:border-blue-500 focus:ring-blue-500 focus:outline-none focus:ring-1 p-2 text-xs rounded-lg pr-8"
                  value={itemsPerPage}
                  onChange={(e) => changeItemsPerPage(Number(e.target.value))}
                  style={{
                    backgroundImage:
                      "linear-gradient(to right, #d1d5db 1px, transparent 1px), url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e\")",
              ...
              <nav>
                <ul className="inline-flex items-center -space-x-px">
                  <li>
                    <button
                      type="button"
                      className={`ml-0 rounded-l-lg border border-gray-300 bg-white px-3 py-2 leading-tight  enabled:hover:bg-gray-100 enabled:hover:text-gray-700 inline-flex items-center gap-1${
                        currentPage === 1
                  ...
                  <li>
                    <button
                      type="button"
                      className={`rounded-r-lg border border-gray-300 bg-white px-3 py-2 leading-tight  enabled:hover:bg-gray-100 enabled:hover:text-gray-700 inline-flex items-center gap-1${
